...
class Misc(commands.Cog, name="Misc"):
	...
	async def invite(self, ctx):
	    embed = discord.Embed(title=f'Invite Me!', description='Here is the link to invite me. Click it!', colour=0xC0C0C0, timestamp=ctx.message.created_at)

	    embed.add_field(name='**Invite Me To Your Server!**', value="**https://discord.com/api/oauth2/authorize?client_id=811349622709944390&permissions=8&scope=bot**")
